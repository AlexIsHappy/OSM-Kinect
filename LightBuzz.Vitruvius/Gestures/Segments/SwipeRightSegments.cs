...
namespace LightBuzz.Vitruvius.Gestures
{
    ...
    public class SwipeRightSegment1 : IGestureSegment
    {
        ...
        public GesturePartResult Update(Body skeleton)
        {
            ...
            if (skeleton.Joints[JointType.HandLeft].Position.Z < skeleton.Joints[JointType.ElbowLeft].Position.Z && skeleton.Joints[JointType.HandRight].Position.Y < skeleton.Joints[JointType.SpineBase].Position.Y + 0.2)
            {
                ...
                if (skeleton.Joints[JointType.HandLeft].Position.Y < skeleton.Joints[JointType.Head].Position.Y && skeleton.Joints[JointType.HandLeft].Position.Y > skeleton.Joints[JointType.SpineBase].Position.Y + 0.2)
                {
